...
The output includes GO and DEG lists in the tables folder and figures in the figures folder.
You must specify the correct file paths in pipeline.R for the script to run successfully.
Two figures from the report are included in the output directory; these also appear in the article's PDF.
